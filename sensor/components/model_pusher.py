...
class ModelPusher:
    ...
    def initiate_model_pusher(self,)->ModelPusherArtifact:
        try:
            ...
            # Creating model pusher dir to save model.pkl
            model_file_path = self.model_pusher_config.model_file_path # artifact/timestamp/model_pusher/model.pkl
            os.makedirs(os.path.dirname(model_file_path),exist_ok=True)
            
            # copying model.pkl to artifact/timestamp/model_pusher/model.pkl
            shutil.copy(src=trained_model_path, dst=model_file_path)

            # saved model dir
            saved_model_path = self.model_pusher_config.saved_model_path # saved_model/timestamp/model.pkl
            os.makedirs(os.path.dirname(saved_model_path),exist_ok=True)

            # copying model.pkl to saved_models/timestamp/model.pkl
