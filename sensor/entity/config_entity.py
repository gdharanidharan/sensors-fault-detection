...
class ModelEvaluationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        ) # artifact/timestamp/model_evaluation/report.yaml
...
class ModelPusherConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        ) # artifact/timestamp/model_pusher

        self.model_file_path = os.path.join(self.model_evaluation_dir,training_pipeline.MODEL_FILE_NAME)
         # artifact/timestamp/model_pusher/model.pkl

        timestamp = round(datetime.now().timestamp()) # timestamp
